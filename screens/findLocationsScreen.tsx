...
export const FindLocationsScreen=()=>{
    ...
    const getInput=()=>{
        ...
        return(
            <Input
                ...
                autoFocus
                selectionColor={theme['color-primary-400']}
        ...
        return(
            ...
            />
                <Button appearance={"ghost"} status="info" onPress={navigation.goBack} style={styles.cancel_btn}>
                    Cancel
                </Button>
            </View>
        )
    ...
    const SuggestedText=({locationItem}:{locationItem:Location})=>{
        ...
        return(
            <View style={[styles.row,styles.suggestionContainer]}>
                <Text>{location}</Text>
            </View>
        )
    }
